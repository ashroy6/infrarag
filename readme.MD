...
3. [What InfraRAG Does](#what-infrarag-does)
4. [New Features Added](#new-features-added)
5. [Current Stack](#current-stack)
6. [Container Layout](#container-layout)
7. [High-Level Request Flow](#high-level-request-flow)
   - [Question Answering Flow](#question-answering-flow)
   - [Ingestion Flow](#ingestion-flow)
   - [Streaming Answer Flow](#streaming-answer-flow)
8. [Project Structure](#project-structure)
9. [How to Start InfraRAG](#how-to-start-infrarag)
10. [Folder Roles](#folder-roles)
    - [backend/](#backend)
    - [frontend/](#frontend)
    - [docs/](#docs)
    - [nginx/](#nginx)
    - [monitoring/](#monitoring)
11. [Core Backend Modules](#core-backend-modules)
12. [Answer Pipelines](#answer-pipelines)
13. [Routing and Orchestration](#routing-and-orchestration)
14. [Retrieval, Reranking, and Generation](#retrieval-reranking-and-generation)
15. [Chat History and Follow-Up Handling](#chat-history-and-follow-up-handling)
16. [Citations and Source Grounding](#citations-and-source-grounding)
17. [Upload and Ingestion System](#upload-and-ingestion-system)
18. [Admin UI](#admin-ui)
19. [Persistent Storage](#persistent-storage)
...
24. [How Selective Ingestion Works](#how-selective-ingestion-works)
25. [How Ingested Data Is Stored](#how-ingested-data-is-stored)
26. [Example Commands](#example-commands)
